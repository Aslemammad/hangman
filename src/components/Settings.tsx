...
import { IranSVG, EnglandSVG, InActiveSoundSVG, ActiveSoundSVG } from './assets';
...
const Settings = () => {
	...
	return (
		<div className={classes.settings}>
			...
			<CircleButton onClick={handleChangeLanguage}>{state.persian ? <IranSVG /> : <EnglandSVG />}</CircleButton>

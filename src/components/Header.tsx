...
const Header: React.FC = () => {
  ...
  const handleTimeEnd = (timeEnd: boolean) =>
    setState((prevState: Store) => ({ ...prevState, timeEnd }));
  useEffect(() => {
  ...
  return (
    <div className={classes.top}>
      ...
      <div
        ...
        style={!state.players ? { justifyContent: "center" } : {}}
      >
        <Bar>
          <p>
            You have <span>{state.remainGuesses + " "}</span>
            chances. Your last guess was
